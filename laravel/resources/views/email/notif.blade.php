...
<td class="content-cell" style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; padding: 35px;">
                                        <!-- Body here -->
<p style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #74787E; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;"><b style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box;">Halo! {{$posting->user->name}}</b><br>
    Horee postingan mu sudah di konfirmasi oleh admin , untuk melihat budaya yang sudah kamu buat 
